...
urlpatterns = (
    ...
    url(r'^infrastructure_categories/$', views.InfrastructureCategoryListView.as_view(),
        name='facility_infrastructure_list'),
    url(r'^infrastructure_categories/(?P<pk>[^/]+)/$',
        views.InfrastructureCategoryDetailView.as_view(),
        name='facility_infrastructure_detail'),
    url(r'^facility_infrastructure/$', views.FacilityInfrastructureListView.as_view(),
        name='facility_infrastructure_list'),
    url(r'^facility_infrastructure/(?P<pk>[^/]+)/$',
